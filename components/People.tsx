        ...
        {people.map((item) => (
          ...
          >
            <Image
              ...
              src={item.image}
              alt={item.name}
              className="object-center object-cover !m-0 !p-0 rounded-full h-40 md:h-60 w-40 md:w-60 border-4 group-hover:scale-105 group-hover:z-30 border-zlata/40  relative transition duration-500"
            />
